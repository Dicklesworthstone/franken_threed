...
| `asupersync` | Path dependency at `/Users/jemanuel/dp/asupersync` (`default-features = false`); resolves to sibling HEAD `f72d80911` plus uncommitted browser-host working-tree changes (16 uncommitted modified files: E0277 local spawn aliases, typed browser_host_services, browser pump edits, net/tcp cfg allows, wasm32 clock work in time/epoch/scheduler/observability, three_lane admission and drain fix); development linkage, not reproducible from any commit yet | Structured concurrency regions, cooperative task polling, timer wakeups, explicit cancellation | PASS (cargo check --lib exit 0 09:20:53Z and native consumer test exit 0 09:32:45Z) | PASS on hz2 via strict RCH (RCH_REQUIRE_REMOTE=1), log rch_f3d_runtime_wasm_build13.log at 09:27:17Z exit 0 | Direct path dependency of crates/f3d-runtime at /Users/jemanuel/dp/asupersync (development linkage). Native and wasm32 compilation verified. |
