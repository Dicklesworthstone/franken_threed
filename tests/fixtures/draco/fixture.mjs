...
export function fixture({
  ...
  const json = {
    ...
    accessors: [
      { type: "VEC3", componentType, count: 3, normalized, min: [0, 0, 0], max: [10, 20, 0] },
        ...
        primitives: [
          {
            ...
            ...(indices ? { indices: 1 } : {}),
            extensions: { [EXT]: { bufferView: 0, attributes: { POSITION: 7 } } },
          },
        ],
      },
    ],
  ...
  const decoder = {
    decodeGeometry(buffer, config) {
      ...
      const geometry = {
        attributes: {},
        index: { itemSize: 1, count: 3, array: new Uint32Array([0, 1, 2]) },
        disposed: 0,
        dispose() {
          this.disposed++;
        },
      };
      for (const key of Object.keys(config.attributeIDs))
        geometry.attributes[key] = {
          itemSize: 3,
          count: 3,
          array: new Types[componentType]([0, 0, 0, 10, 0, 0, 0, 20, 0]),
          normalized: false,
        };
